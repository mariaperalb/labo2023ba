...
PARAM <- list()
PARAM$experimento <- "FE6310_vf"

PARAM$exp_input <- "DR6210_vf"
...
PARAM$RandomForest$semilla <- 100151 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 100151
