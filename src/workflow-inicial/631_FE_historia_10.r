...
PARAM <- list()
PARAM$experimento <- "FE6310_10"

PARAM$exp_input <- "DR6210_10"
...
PARAM$RandomForest$semilla <- 100153 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 1.1
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 10.0
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 100153
